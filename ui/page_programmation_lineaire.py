...
class PageProgrammationLineaire(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = ttk.Label(self, text="Programmation lineaire", font=("Arial", 24))
    ...
    def objective_container(self) :
        ...
        self.coeff_x = ttk.Entry(container, width=4)
        ...
        self.coeff_y = ttk.Entry(container, width=4)
    ...
    def extraire_valeur_contrainte(self):
        ...
        for contrainte in self.contrainte_list:
            contrainte_data = {}
            coeff_x = contrainte[1].get()
            coeff_y = contrainte[3].get()
            signe = contrainte[5].get()
            second_membre = contrainte[6].get()
    ...
    def resultat_opt(self): 
        ...
        l_0.pack(fill="x", pady=0, padx=24)
        ...
        l_1.grid(row=0, column=0, columnspan= 10, sticky="w", pady= 10)
        ...
        l_x.grid(row=0, column=0, columnspan= 10, sticky="w", pady= 4)
        ...
        l_val_opt.grid(row=2, column=0, columnspan= 10, sticky="w", pady= 4)
        ...
        btn_graphique.grid(row=3, column=0, sticky="w", pady= 4)
